...
\copy stores (Store, Type, Size) FROM 'demo/retail_data/data/stores.csv' CSV DELIMITER ',' HEADER;
...
\copy features (id, Store, Date, Temperature, Fuel_Price, CPI, Unemployment, IsHoliday) FROM 'demo/retail_data/data/features.csv' CSV DELIMITER ',' HEADER;
-- Install sales table
...
\copy sales (id, Store, Date, Weekly_Sales, IsHoliday) FROM 'demo/retail_data/data/sales.csv' CSV DELIMITER ',' HEADER;
