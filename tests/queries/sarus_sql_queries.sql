...
SELECT marital_status, SUM(capital_loss / 100000) AS my_sum, SUM(education_num) AS sum_education_num FROM census WHERE education_num > 0 AND education_num < 15 AND capital_loss > 2231 AND capital_loss < 4356 GROUP BY marital_status HAVING marital_status = 'Divorced';
...
SELECT SUM(education_num) AS my_sum FROM census  WHERE age >20 AND age < 90 AND education_num > 0 AND education_num < 15 GROUP BY LOG(CASE WHEN age < 50 THEN 50 ELSE 1 END);
SELECT COUNT(education_num) As my_sum FROM census  WHERE age >20 AND age < 90 AND education_num > 0 AND education_num < 15 GROUP BY CASE WHEN age < 50 THEN 50 ELSE 1 END;
...
SELECT age AS age1, SUM(education_num) AS my_sum FROM census WHERE education_num > 0 AND education_num < 15 GROUP BY age1 ORDER BY age1;
SELECT SUM(age) AS my_sum FROM census WHERE age >20 AND age < 90 AND education_num > 0 AND education_num < 15 GROUP BY marital_status, CASE WHEN age > 90 THEN 1 ELSE 0 END;
SELECT SUM(age) AS my_sum FROM census  WHERE age >20 AND age < 90 AND education_num > 0 AND education_num < 15 GROUP BY marital_status, CASE WHEN age > 90 THEN 1 ELSE 0 END ORDER BY my_sum;
SELECT CASE WHEN age > 80 THEN 1 ELSE 0 END As my_age, SUM(age) AS my_sum FROM census WHERE age >20 AND age < 90 GROUP BY marital_status, CASE WHEN age > 80 THEN 1 ELSE 0 END ORDER BY my_sum;
SELECT CASE WHEN age > 90 THEN 1 ELSE 0 END AS my_col, SUM(age) AS my_sum FROM census WHERE age >20 AND age < 90 GROUP BY my_col ORDER BY my_sum;
...
SELECT SUM(capital_loss) AS s1 FROM census WHERE capital_loss > 2231 AND capital_loss < 4356 GROUP BY capital_loss;
...
SELECT SUM(log_capital_loss) AS res1, SUM(sqrt_capital_loss) AS res2, SUM(inv_capital_loss) AS res3 FROM (SELECT LOG(capital_loss + 1.) AS log_capital_loss, SQRT(capital_loss) AS sqrt_capital_loss, 1/(capital_loss+1) AS inv_capital_loss FROM census WHERE capital_loss < 40000 AND capital_loss > 1) AS subquery;
...
SELECT SUM(s1) AS res1, SUM(s2)  AS res2 FROM (SELECT SUM(DISTINCT capital_loss) AS s1, SUM(DISTINCT age) AS s2 FROM census WHERE age > 20 AND age < 90 AND capital_loss > 2231 AND capital_loss < 4356 GROUP BY sex HAVING COUNT(*) > 5) AS sq;
...
SELECT sex, COUNT(DISTINCT age) AS res1, AVG(DISTINCT age) AS res2, SUM(DISTINCT age) AS res3, AVG(DISTINCT age) AS res4, VARIANCE(DISTINCT age) AS res5, STDDEV(DISTINCT age) AS res6 FROM census WHERE age > 20 AND age < 90 GROUP BY sex;
...
SELECT COUNT(*) AS res, SUM(DISTINCT age) AS my_sum FROM census WHERE age > 20 AND age < 90 GROUP BY CEIL(capital_loss / 100);
