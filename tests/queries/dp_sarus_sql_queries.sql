...
SELECT age AS age1, SUM(education_num) FROM census WHERE education_num > 0 AND education_num < 15 GROUP BY age1 ORDER BY age1;
...
SELECT CASE WHEN age > 80 THEN 1 ELSE 0 END, SUM(age) AS my_sum FROM census WHERE age >20 AND age < 90 GROUP BY marital_status, CASE WHEN age > 80 THEN 1 ELSE 0 END ORDER BY my_sum;
